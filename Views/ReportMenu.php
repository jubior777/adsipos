    ...
    <div class="panel-body">
        <div align="right">
            ...
            <button href="#add3" title="" data-placement="left" data-toggle="modal"
                    class="btn btn-primary tooltips" type="button"
                    data-original-title="Buscar Reporte por año"><span
                        class="fa fa-plus"></span> REPORTE POR AÑO
            </button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 id="myModalLabel" align="center">Buscar Reporte por Año</h3>
                        </div>

                        <div class="modal-body">
                            <label class="col-sm-2 control-label"> Buscar Año </label>
